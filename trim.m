...
params.S_fp = 2.8 * 0.0929; % Converting to m2. Airframe equivalent flat plate area [ft^2] - Maryland paper

% Force Equilibrium and Rotor Tilting
Td = params.W;
...
delta_y = params.deltaY; % Distance in y from shaft to CG
...
% Assume shaft angle alpha_r is close to alpha_d
alpha_r = alpha_d;
...
% Assume uniform induced velocity v_i (taken from MT)
lambda_i = results_MT.vi / (params.Omega * params.R);

% Blade Dynamics System
